import { Box, Card, Text, Flex, Heading, Button, jsx } from "theme-ui";
...
const styles = {
  ...
  ctaButtonContainer: {
    textAlign: "center",
    mt: "auto", // Ensures it takes remaining space and pushes button to the bottom
    mb: "20px", // Adds a little margin at the bottom
    position: "absolute",
    bottom: "20px",
    left: 0,
    right: 0,
